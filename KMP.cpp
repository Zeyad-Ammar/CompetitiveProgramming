const int N=1e5+5;
struct KMP{//can give u ans vector that have all index that this pattern appeared.
    ...
    void kmp(string s,string pat)//pass the string and the pattern u want to search about.
    {
